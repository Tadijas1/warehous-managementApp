...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/magazine-managementApp
OBJDIR = obj/x64/Debug/magazine-managementApp
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/magazine-managementApp
OBJDIR = obj/x86/Debug/magazine-managementApp
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/magazine-managementApp
OBJDIR = obj/ARM64/Debug/magazine-managementApp
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGET = $(TARGETDIR)/magazine-managementApp
OBJDIR = obj/x64/Release/magazine-managementApp
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/magazine-managementApp
OBJDIR = obj/x86/Release/magazine-managementApp
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/magazine-managementApp
OBJDIR = obj/ARM64/Release/magazine-managementApp
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking magazine-managementApp
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning magazine-managementApp
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
...
$(OBJDIR)/button_texture.o: src/button_texture.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/button_type.o: src/button_type.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/profile.o: src/profile.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/topbar.o: src/topbar.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
